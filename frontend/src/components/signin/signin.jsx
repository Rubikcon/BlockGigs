...
const signin = () => {
  ...
  <form action="#" className="w-[300px] h-[550px] lg:w-[422px] lg:h-[615px] rounded-xl bg-[#ffffff] flex flex-col items-center" onSubmit={handleSubmit}>
    ...
    <div className='w-[260px] lg:w-[350px] h-[103px] gap-1 flex flex-col items-start mt-[1.4rem]'>
      <label htmlFor="email" className='font-montserrat font-medium text-[14px] leading-6 text-[#292929]'>Email Address</label>
    ...
    <button type='submit' className='absolute right-0 lg:right-3  w-[36px] h-[33.33px] top-[35px] left-[220px] lg:left-[306px] rounded-[6.67px] p-[10px] gap-2.5 bg-[#2f66f6] cursor-pointer'> <FaArrowRightLong className="text-[#fafafa] pointer-events-none " /> </button>
    ...
    <div className="flex flex-col items-center gap-3 w-[300px] lg:w-[350px] h-[192px] mt-4">
      <button className="flex items-center cursor-pointer w-[250px] lg:w-[350px] h-[56px] px-[24px] py-[16px] gap-[16px] rounded-[16px] border border-[#E8E8E8] bg-[#FAFAFA]">
        ...
        <span  className='font-montserrat font-medium text-[14px] leading-6 text-[#272954]'>Metamask</span>
      </button>
      <button className="flex items-center cursor-pointer w-[250px] lg:w-[350px] h-[56px] px-[24px] py-[16px] gap-[16px] rounded-[16px] border border-[#E8E8E8] bg-[#FAFAFA] ">
        <img src={celo} alt="celo logo" />
        <span className='font-montserrat font-medium text-[14px] leading-6 text-[#272954]'>Celo</span>
      </button>
      <button className="flex items-center cursor-pointer w-[250px] lg:w-[350px] h-[56px] px-[24px] py-[16px] gap-[16px] rounded-[16px] border border-[#E8E8E8] bg-[#FAFAFA] ">
        <img src={wallet} alt="wallet logo" />
        <span  className='font-montserrat font-medium text-[14px] leading-6 text-[#272954]'>Wallet connect</span>
      </button>
    </div>
