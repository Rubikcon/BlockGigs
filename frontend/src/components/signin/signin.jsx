        ...
        <form onSubmit={handleSubmit} className="w-[300px] h-[550px] lg:w-[422px] lg:h-[615px] rounded-xl bg-[#ffffff] flex flex-col items-center">
          ...
          <div className='w-[260px] lg:w-[350px] h-[103px] gap-1 flex flex-col items-start mt-[1.4rem]'>
            ...
            <div className="relative flex items-center mt-[-1.8rem]">
              ...
              />
              <button type='submit' className='absolute right-0 lg:right-3 w-[36px] h-[33.33px] top-[35px] left-[220px] lg:left-[306px] rounded-[6.67px] p-[10px] gap-2.5 bg-[#2f66f6] cursor-pointer'>
